...
import { Loader2, Plus, Trash2, Paperclip, Clock, User, FileText, X } from "lucide-react";
...
export function HistoricoTab({ clienteId, empreendimentoId }: Props) {
  ...
  const fetchHistoricos = useCallback(async () => {
    ...
    try {
      ...
      if (empreendimentoId) params.set("empreendimentoId", String(empreendimentoId));
  ...
  async function handleAdd() {
    ...
    try {
      ...
      if (empreendimentoId) formData.set("empreendimentoId", String(empreendimentoId));
