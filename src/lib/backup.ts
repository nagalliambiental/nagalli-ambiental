...
export async function buildBackupWorkbook() {
  ...
  addSheet(wb, "Tarefas", tarefas.map((t) => ({
    ...
    "Prazo Final": fmtData(t.prazoFinal),
    "Dias p/ Prazo": diasAte(t.prazoFinal),
    "Data Limite": fmtData(t.dataLimite),
    "Dias p/ Limite": diasAte(t.dataLimite),
    "Alerta Prazo": t.alertaPrazoFinal,
    "Alerta Limite": t.alertaDataLimite,
